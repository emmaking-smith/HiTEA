### HOMOGENEOUS ANOVA-TUKEY CORRELATIONS ###
...
# dalkene.aov.factor <- aov(z_score ~ cat_lig, data=dalkene)
...
#   
#   
#   if (grepl("[B-](F)(F)(F)F.[Rh+].C1=CCCC=CCC1.C1=CCCC=CCC1+P(C1C([C@H](P(C(C)(C)C)C(C)(C)C)C)CCC1)(c1ccccc1)c1ccccc1.C1CCCC1.[Fe]-", i, fixed=T) ==T) {
...
#   }
#   
#   else if (grepl("[B-](F)(F)(F)F.[Rh+].C1=CCCC=CCC1.C1=CCCC=CCC1+c1(c2c(P(c3cc(cc(c3)C)C)c3cc(cc(c3)C)C)ccc3c2cccc3)c(P(c2cc(cc(c2)C)C)c2cc(cc(c2)C)C)ccc2c1cccc2-", i, fixed=T) ==T) {
#     f1 <- "[B-](F)(F)(F)F.[Rh+].C1=CCCC=CCC1.C1=CCCC=CCC1+c1(c2c(P(c3cc(cc(c3)C)C)c3cc(cc(c3)C)C)ccc3c2cccc3)c(P(c2cc(cc(c2)C)C)c2cc(cc(c2)C)C)ccc2c1cccc2"
#     f2 <- substr(i, nchar(f1) + 2, nchar(i))
#   }
#   
#   else if (grepl("RuCl2[(R)-dm-segphos®][(R,R)-dpen]+-", i, fixed=T) ==T) {
#     f1 <- "RuCl2[(R)-dm-segphos®][(R,R)-dpen]+"
#     f2 <- substr(i, nchar(f1) + 2, nchar(i))
#   }
#   
#   else if (grepl("-[B-](F)(F)(F)F.[Rh+].C1=CCCC=CCC1.C1=CCCC=CCC1+c1(c2c(P(c3cc(cc(c3)C)C)c3cc(cc(c3)C)C)ccc3c2cccc3)c(P(c2cc(cc(c2)C)C)c2cc(cc(c2)C)C)ccc2c1cccc2", i, fixed=T) ==T) {
#     f2 <- "[B-](F)(F)(F)F.[Rh+].C1=CCCC=CCC1.C1=CCCC=CCC1+c1(c2c(P(c3cc(cc(c3)C)C)c3cc(cc(c3)C)C)ccc3c2cccc3)c(P(c2cc(cc(c2)C)C)c2cc(cc(c2)C)C)ccc2c1cccc2"
#     f1 <- substr(i, 1, nchar(i) - nchar(f2) - 1)
#   }
#   
#   else {
...
# 
# homo_alkene_outlier_cats <- data.table(factor = as.character(), avg_zscore = as.numeric())
# 
# for (i in un_factors_dt[, factor][1:15]) {
#   zscores <- dalkene[cat_lig == i, z_score]
#   avg <- mean(zscores)
#   homo_alkene_outlier_cats <- rbind(homo_alkene_outlier_cats, list(i, avg))
# }
